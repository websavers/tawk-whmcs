 ...
 * with WHMCS's behaviour of not associating a ticket with a client/user unless the user is logged 
 * into their account. You may be comfortable using it if you only show your tawk widget to logged in customers.
